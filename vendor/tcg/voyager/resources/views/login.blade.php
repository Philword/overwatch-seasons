...
<head>
    ...
    <style>
        ...
        body.login .login-sidebar {
            border-top:5px solid {{ config('voyager.primary_color','#ff9b00') }};
        }
        .navbar-brand {
        font-size: 15px;
        ...
        @media (max-width: 767px) {
            .login-sidebar {
                ...
                border-left:5px solid {{ config('voyager.primary_color','#ff9b00') }};
            }
        }
        body.login .form-group-default.focused{
            border-color:{{ config('voyager.primary_color','#ff9b00') }};
        }
        .login-button, .bar:before, .bar:after{
            background:{{ config('voyager.primary_color','#ff9b00') }};
        }
    </style>
